window.onscroll = function() {
    ...
    var winScrollTop = window.pageYOffset,
        navBar = document.getElementById("nav-iPad"),
        theAboutSec = document.getElementById("parallax-iPad"),
        theSkillsSec = document.getElementById("block-name-iPad"),
        theLIst = document.getElementById("list_ul-iPad"),
...
navButton.onclick = function() {
    "use strict";
    var listDiv = document.getElementById("main_list-iPad");
