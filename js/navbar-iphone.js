window.onscroll = function() {
    ...
    var winScrollTop = window.pageYOffset,
        navBar = document.getElementById("nav-iPhone"),
        theAboutSec = document.getElementById("parallax-iPhone"),
        theSkillsSec = document.getElementById("block-name-iPhone"),
        theLIst = document.getElementById("list_ul-iPhone"),
...
navButton.onclick = function() {
    "use strict";
    var listDiv = document.getElementById("main_list-3");
