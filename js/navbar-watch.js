window.onscroll = function() {
    ...
    var winScrollTop = window.pageYOffset,
        navBar = document.getElementById("nav-watch"),
        theAboutSec = document.getElementById("parallax-watch"),
        theSkillsSec = document.getElementById("block-name-watch"),
        theLIst = document.getElementById("list_ul-watch"),
...
navButton.onclick = function() {
    "use strict";
    var listDiv = document.getElementById("main_list-watch");
