...
<body style="opacity: 0;transition: .9s;">
    ...
    <header id="head">
        ...
        <nav class="nav fixed" id="nav-iPhone" style="z-index:100;">
            <div class="container-fluid">
                <div class="logo">
                    <a href="index.php" id="name"><span class="mk">MK</span>dir</a>
                    <!-- <h1 data-scroll id=""> <span class="mk">MK</span>dir</h1> -->
                </div>
                <div class="main_list" id="main_list-3">
                    <ul id="list_ul-iPhone">
                        <li><a href="#parallax-iPhone">Home</a></li>
                        <li><a data-scroll href="#block-name-iPhone">Store</a></li>
    ...
    <div id="fixed-panel-iPhone" class="d-none d-md-block">
        ...
        <a id="go-top-trans" href="index.php">
            <div id="go-top" title="Back to menu">
    ...
    <div id="parallax-iPhone" class="parallax-iPhone">

        <div class="parallax-container">
            <h1 class="lax" data-lax-translate-y="0 0, 600 -300">iPhone</h1>
        ...
        <div class="parallax-container secondary align-middle text-center lax" data-lax-opacity="0 0, 500 1">
            <h2>Just the right </h2>
            <p class="subtext">amount of everything.</p>
            <p>
        ...
        <img id="header-iPhone" src="content/home/iPhone-home.png" alt="Back" class="back">
    </div>
    ...
    <div id="iPhone-page">
        <h2 id="block-name-iPhone" class="text-center">
            Store
        </h2>
        <div class="container-fluid">
            <!-- LINE-1 -->
            <div class="row align-items-center macbookAir">
                <div id="disc-1" class="col-3 disc-1 text-center">

                    <h1 id="fly-it" class="name-mac" style="color:whitesmoke;">iPhone SE</h1>

                </div>
                <div id="disc-1" class="col-sm-3  disc-1 d-none d-md-block text-center">
                    <div id="buy-1" class="shift-3 buy ">
                        <a href="#">Buy</a>
                    </div>
                </div>

                <div id="photo-1" class="col-md-6 col-9 photo-1 text-center ">
                    <img id="fade" src="content/home/iphone-4.jpg" width="100%" alt="macbook">
                </div>

                <div class="col-sm-12 d-block d-md-none text-center">
                    <div id="buy-1" class="shift-3">
                        <a href="#">Buy</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div id="photo-2" class="col-md-6 col-9 photo-2 text-center">
                    <img id="fly-i" src="content/home/iphone-8.jpg" alt="macbook" width="100%">
                </div>

                <div id="disc-1" class="col-sm-3  disc-1 d-none d-md-block text-center">
                    <div id="buy-2" class="shift-3 buy">
                        <a href="#">Buy</a>
                    </div>
                </div>

                <div id="disc-2" class="col-3 disc-2 text-center">
                    <h1 id="fade-i" class="name-mac-middle" style="color:whitesmoke;">
                        iPhone 11
                    </h1>
            ...
            <!-- LINE-3 -->
            <div class="row align-items-center macbookAir">
                <div id="disc-3" class="col-3 disc-1  text-center">
                    <h1 id="fly" class="name-mac" style="color:whitesmoke;">
                        iPhone 11Pro
                    </h1>

                </div>
                <div id="disc-3" class="col-sm-3  disc-1 d-none d-md-block text-center">
                    <div id="buy-1" class="shift-3 buy">
                        <a href="#">Buy</a>
                    </div>
                </div>

                <div id="photo-3" class="col-md-6 col-9 photo-1 text-center">
                    <img class="fade-it" src="content/home/iphone-1.jpg" width="100%" alt="macbook">
                </div>

                <div class="col-sm-12 d-block d-md-none text-center">
                    <div id="buy-3" class="shift-3">
                        <a href="#">Buy</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div id="footer-items" class="row">
                <div id="footer-content" class="col-md-3 col-sm-12">
                    ...
                    <ul>
                        <li><a href="#parallax-iPhone">Home</a></li>
                        <li><a href="#block-name-iPhone">Store</a></li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#main_list-3").on("click", "a", function(event) {
    ...
    <script src="js/navbar-iphone.js"></script>
