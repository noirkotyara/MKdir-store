    ...
    <body style="opacity: 0;transition: .9s;">
        ...
        <div id="parallax" class="parallax">
            ...
            <div class="parallax-container">
                <h1 class="lax" data-lax-translate-y="0 0, 600 -300">MAC</h1>
        ...
        <h2 id="block-nameMAC" class="text-center">
            Store
        </h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div id="photo-2" class="col-md-6 col-9 photo-2 text-center">
                        <img id="fly-i" src="content/home/macbookAir.jpg" alt="macbook" width="100%">
                    </div>

                    <div id="disc-1" class="col-sm-3  disc-1 d-none d-md-block text-center">
                        <div id="buy-2" class="shift-3 buy">
                            <a href="iMac-s2.php">Buy</a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center macbookAir">
                    ...
                    <div id="disc-3" class="col-sm-3  disc-1 d-none d-md-block text-center">
                        <div id="buy-1" class="shift-3 buy">
                            <a href="iMac-s3.php">Buy</a>
                        </div>
                    </div>

                    <div id="photo-3" class="col-md-6 col-9 photo-1 text-center">
                        <img class="fade-it" src="content/home/macbook.jpg" width="100%" alt="macbook">
                    </div>
