...
?> 
    ...
    <body style="opacity: 0;transition: .9s;">
        ...
        <header id="head">
            ...
            <nav class="nav fixed" id="nav-iPad" style="z-index:100;">
                <div class="container-fluid">
                    <div class="logo">
                        <a href="index.php" id="name"><span class="mk">MK</span>dir</a>

                    </div>
                    <div class="main_list" id="main_list-iPad">
                        <ul id="list_ul-iPad">
                            <li><a href="#parallax-iPad">Home</a></li>
                            <li><a data-scroll href="#block-name-iPad">Store</a></li>
        ...
        <div id="parallax-iPad" class="parallax">

            <div class="parallax-container">
                <h1 class="lax" data-lax-translate-y="0 0, 600 -300">iPad</h1>
            ...
            <img id="header-iPad" src="content/home/iPad-home.png" alt="Back" class="back">
        </div>

        <h2 id="block-name-iPad" class="text-center">
            Store
        </h2>
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center macbookAir">
                    <div id="disc-1" class="col-3 disc-1 text-center">
                        ...
                        <h1 id="fly-it" class="name-mac" style="color:black;">iPad</h1>
                    ...
                    <div id="photo-1" class="col-md-6 col-9 photo-1 text-center ">
                        <img id="fade" src="content/home/ipad-1.jpg" width="100%" alt="macbook">
                    </div>
                ...
                <div class="row align-items-center">
                    <div id="photo-2" class="col-md-6 col-9 photo-2 text-center">
                        <img id="fly-i" src="content/home/ipad-2.png" alt="macbook" width="100%">
                    </div>
                ...
                <div class="row align-items-center macbookAir">
                    ...
                    <div id="photo-3" class="col-md-6 col-9 photo-1 text-center">
                        <img class="fade-it" src="content/home/iPadmini.jpg" width="100%" alt="macbook">
                    </div>
                ...
                <div id="footer-items" class="row">
                    <div id="footer-content" class="col-md-3 col-sm-12">
                        ...
                        <ul>
                            ...
                            <li><a href="#parallax-iPad">Home</a></li>
                            <li><a href="#block-name-iPad">Store</a></li>
    ...
    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script> -->
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#main_list-iPad").on("click", "a", function(event) {
        ...
        <script src="js/navbar-ipad.js"></script>
